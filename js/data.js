const DECK = {
  "WHY SUNESTA": [
    ...
    },
    {
      ...
      talkingPoints:["Exclusive Gutter Helmet dealer — 4,000+ local customers","Motorized screens: UV + heat + wind resistance","Louvered roofs: commercial grade, pairs with screens for 3-season living","Plant seeds — don't pitch. Tap a row for detail."],
  ...
  "STORY OF SUNESTA": [
    ...
    },
    {
      ...
      rows:[
        {icon:IMAGES.badgeMiamiDade, label:"Miami Dade (NOA #24-0401.03)", detail:"Sunesta is the first retractable awning manufacturer to exceed Miami-Dade's strict standards. Arms tested to 98 mph before failure."},
      ...
      coach:"Stack credibility fast and keep moving. Icons are placeholder crops for now. The Google reviews row links out to the real ATH review page."
    },
    {
